...
public class ApiGatewayConfiguration {
	...
	public RouteLocator gateway(RouteLocatorBuilder builder) {
		// u path se unosi string ; gateway poredi zahtjev koji smo poslali sa stringom ovdje sto smo naveli u path. Ove ** kazu da poslije / dolaze jos neki direktorijumi
		//kada se potvrdi sablon onda ide do ovoga lb, da nadje instancu currency-excange
		//path kao sablon za prepoznavanje zahtjeva, ali i za lokaciju kojoj saljemo rikvest

		//imamo vise zahtjeva ka currency-conversion. Svaka metoda radi isto, samo razlicite varijante. Svaki od zahtjeva da usmjerimo na feign
		//mijenja currency-conversion u ovaj feign nakon sto je sablon potvrdjen
